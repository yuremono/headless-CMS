...
export function ImageFieldInput( {
        ...
        const [uploadError,
        setUploadError]=useState('');
        const [isLibraryOpen,
        setIsLibraryOpen]=useState(false);
        const [libraryAssets,
        setLibraryAssets]=useState<ApiAssetRecord[]>([]);
        const [libraryLoading,
        setLibraryLoading]=useState(false);
        const [libraryError,
        setLibraryError]=useState('');
