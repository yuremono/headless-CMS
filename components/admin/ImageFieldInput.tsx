  ...
  return (
    <div className="ImageFieldInput block">
      <div className="flex items-center gap-2 text-sm font-medium text-white">
        <span>{label}</span>
        {required ? <span className="rounded-full bg-sky-400/15 px-2 py-0.5 text-xs text-sky-200">必須</span> : null}
      </div>
      ...
      {isLibraryOpen ? (
        ...
        >
          <div className="ImageFieldInput_modalPanel flex max-h-[90vh] w-full max-w-5xl flex-col overflow-hidden rounded-3xl border border-white/10 bg-slate-900 shadow-2xl">
