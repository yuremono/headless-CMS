  ...
  return (
    <div className="SeoFields lg:col-span-2">
      <header className="SeoFields_header">
        ...
        >
          <span className="rounded-full bg-violet-400/15 px-2 py-0.5 text-xs text-violet-200">SEO</span>
          <span className="min-w-0 flex-1 truncate text-sm font-medium text-white">{previewTitle}</span>
          <span className="text-xs text-slate-400">{isOpen ? '閉じる' : '開く'}</span>
        </button>
      </header>
        ...
        <div className="SeoFields_body">
          <div className="SeoFields_grid grid gap-5 lg:grid-cols-2">
            <label className="block">
              <span className="text-sm font-medium text-white">SEOタイトル</span>
              <input
            ...
            <label className="block">
              <span className="text-sm font-medium text-white">OGタイトル</span>
              <input
                className={inputClass}
            ...
            <label className="block lg:col-span-2">
              <span className="text-sm font-medium text-white">SEO説明</span>
              <textarea
                className={inputClass}
                rows={3}
            ...
            <label className="block lg:col-span-2">
              <span className="text-sm font-medium text-white">OG説明</span>
              <textarea
                className={inputClass}
                rows={3}
            ...
            <label className="block">
              <span className="text-sm font-medium text-white">OG画像</span>
              <input
                className={inputClass}
            ...
            <label className="block">
              <span className="text-sm font-medium text-white">canonical URL</span>
              <input
                className={inputClass}
                type="url"
            ...
            <div className="block lg:col-span-2">
              ...
              <button
                ...
                onClick={() => onChange('seo.noindex', !Boolean(draft['seo.noindex']))}
              >
                <span>{Boolean(draft['seo.noindex']) ? '検索エンジンに索引しない' : '通常どおり索引する'}</span>
                <span
