  ...
  return (
		<main className="flex min-h-screen items-center justify-center bg-slate-950 px-4 py-10 text-slate-100">
			<div className="grid w-full max-w-5xl gap-8 lg:grid-cols-[0.9fr_1.1fr]">
				<section className=" border border-white/10 bg-white/5 p-6 shadow-2xl shadow-slate-950/30">
					...
					<p className="mt-4 text-sm leading-7 text-slate-300">
						Phase 3
						骨格ではデモ用アカウントでセッションを発行します。
						本番では Auth.js または Supabase Auth
						に切り替え、`CMS_ENFORCE_ADMIN_LOGIN` で UI
						ガードを有効化します。
					</p>
