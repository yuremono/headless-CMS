/**
 * Thin MCP adapter over lib/cms-agent.
 * listContent is the only helper here (not yet on CmsAgentClient).
 */

import type { CmsAgentConfig, CmsClientResult } from '@/lib/cms-agent/types';

export { createCmsAgentClient } from '@/lib/cms-agent/api-client';
export type {
  AssetRecord,
  CmsAgentConfig,
  CmsClientResult,
